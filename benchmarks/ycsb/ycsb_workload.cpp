...
void YCSBWorkloadPartitioner::per_thread_write_to_file(
...
void *YCSBWorkloadPartitioner::compute_data_info_helper(void *data) {
  ...
  auto partitioner = reinterpret_cast<YCSBWorkloadPartitioner *>(

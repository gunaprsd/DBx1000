...
void TPCCAccessGraphPartitioner::first_pass() { assert(false); }

void TPCCAccessGraphPartitioner::second_pass() { assert(false); }

void TPCCAccessGraphPartitioner::third_pass() { assert(false); }
